...
func (tradingSuite *UniswapTradingTestSuite) Test4TradeMRKForEthWithUniswap(){

	_, ethBlockHash, ethTxIdx, ethDepositProof, err := getETHDepositProof(tradingSuite.ETHHost, common.HexToHash("0xf89601bf682fad2016abab397fb554f3b3efca4cb217de791250148f28374da0"))
	require.Equal(tradingSuite.T(), nil, err)
	fmt.Println("depositProof ---- : ", ethBlockHash, ethTxIdx, ethDepositProof)
}
